...
namespace Jibril.Extensions
{
    public static class StringExtension
    {
        ...
        private static readonly Regex scamFilterSteam = new Regex(@"(?:linkd\.in|t\.co|bitly\.co|tcrn\.ch|bit\.ly|steam-community\.com|goo\.gl|tinyurl\.com|ow\.ly|strawpoli\.|steam-halloween\.com|google\.com|snip\.li|pointsprizes\.com|paysafecards\.org).*?(\s|$)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
