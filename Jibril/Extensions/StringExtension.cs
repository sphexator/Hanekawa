...
namespace Jibril.Extensions
{
    public static class StringExtension
    {
        ...
        private static readonly Regex scamFilterSteam = new Regex(@"(?:linkd\.in|t\.co|bitly\.co|tcrn\.ch|bit\.ly|steam-community\.com|goo\.gl|tinyurl\.com|ow\.ly|strawpoli\.).*?(\s|$)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
