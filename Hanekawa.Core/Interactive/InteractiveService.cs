...
namespace Hanekawa.Core.Interactive
{
    public class InteractiveService : IDisposable
    {
        ...
        public Task<SocketMessage> NextMessageAsync(HanekawaContext context,
        ...
        public async Task<SocketMessage> NextMessageAsync(HanekawaContext context,
        ...
        public async Task<IUserMessage> SendPaginatedMessageAsync(HanekawaContext context,
