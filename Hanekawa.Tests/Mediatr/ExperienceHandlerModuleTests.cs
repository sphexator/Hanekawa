...
public class ExperienceHandlerModuleTests
{
    ...
    [Fact]
    public async Task HandleAsync_AdjustsUpperBound_WhenOnlyUpperConfiguredBelowDefaultLower()
    {
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
        ...
        Assert.Equal(20, captured.Count);
        Assert.All(captured, experience => Assert.Equal(1, experience));
    }

    [Fact]
    public async Task HandleAsync_RaisesUpperBound_WhenOnlyLowerConfiguredAboveDefaultUpper()
    {
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
        ...
        Assert.Equal(25, captured.Count);
        Assert.All(captured, experience => Assert.InRange(experience, 10, 10));
    }
    ...
    public async Task HandleAsync_AdjustsUpperBound_WhenUpperLessThanOrEqualToLower()
    {
        ...
        Assert.Equal(30, captured.Count);
        Assert.All(captured, experience => Assert.Equal(10, experience));
    }
