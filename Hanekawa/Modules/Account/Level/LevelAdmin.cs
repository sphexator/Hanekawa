...
namespace Hanekawa.Modules.Account.Level
{
    ...
    public class LevelAdmin : InteractiveBase
    {
        ...
        [Summary("**Require Manage Server**\nToggles between level roles stacking or keep the highest earned one")]
        ...
        [Alias("lvl create")]
        [Summary("**Require Manage Server**\nCreates a role reward with given level and name")]
        ...
        [Alias("lvl remove")]
        [Summary("**Require Manage Server**\nRemoves a role reward with given level")]
