...
namespace Hanekawa.Bot.Preconditions
{
    ...
    public class RatelimitAttribute : PreconditionAttribute
    {
        ...
        ///     false.
        /// </param>
        public RatelimitAttribute(int times, double period, Measure measure, bool noLimitInDMs = false,
        ...
        ///     false.
        /// </param>
        public RatelimitAttribute(int times, TimeSpan period, bool noLimitInDMs = false, bool noLimitForAdmins = false)
        {
            _invokeLimit = times;
            _noLimitInDMs = noLimitInDMs;
            _noLimitForAdmins = noLimitForAdmins;
