    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    GuildId = table.Column<long>(nullable: false),
                    Leader = table.Column<long>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubInfos", x => new { x.Id, x.GuildId, x.Leader });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubPlayers", x => new { x.Id, x.ClubId, x.GuildId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GlobalStores", x => x.ItemId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClubChannelCategory = table.Column<long>(nullable: true),
                    ClubAdvertisementChannel = table.Column<long>(nullable: true),
                    ClubEnableVoiceChannel = table.Column<bool>(nullable: false),
                    ClubChannelRequiredAmount = table.Column<int>(nullable: false),
                    ClubChannelRequiredLevel = table.Column<int>(nullable: false),
                    ClubAutoPrune = table.Column<bool>(nullable: false),
                    WelcomeChannel = table.Column<long>(nullable: true),
                    WelcomeLimit = table.Column<int>(nullable: false),
                    WelcomeBanner = table.Column<bool>(nullable: false),
                    WelcomeMessage = table.Column<string>(nullable: true),
                    WelcomeDelete = table.Column<TimeSpan>(nullable: true),
                    ...
                    BoardEmote = table.Column<string>(nullable: true),
                    BoardChannel = table.Column<long>(nullable: true),
                    SuggestionChannel = table.Column<long>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryGlobals", x => new { x.UserId, x.ItemId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<decimal>(nullable: true),
                    Name = table.Column<string>(nullable: true),
                    ...
                    ConsumeOnUse = table.Column<bool>(nullable: false),
                    SecretValue = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServerStores", x => new { x.GuildId, x.ItemId });
                });
