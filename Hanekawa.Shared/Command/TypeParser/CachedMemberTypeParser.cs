...
{
    public class CachedMemberTypeParser : HanekawaTypeParser<CachedMember>
    {
        ...
        public override ValueTask<TypeParserResult<CachedMember>> ParseAsync(Parameter parameter, string value,
