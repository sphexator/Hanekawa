...
public class Metrics(IMeterFactory meterFactory) : IMetrics
{
    ...
    public TrackedDuration All(string name, ulong? guildId = null)
    {
        ...
        return new TrackedDuration(TimeProvider.System, metric.Histogram);
    }

    /// <inheritdoc />
    public void IncrementCounter<T>(ulong? guildId = null)
    {
        IncrementCounter(nameof(T));
    }
    ...
    {
        return MeasureDuration(nameof(T));
    }
    ...
    public TrackedDuration MeasureDuration(string name, ulong? guildId = null)
    {
        ...
        return new TrackedDuration(TimeProvider.System, collection.Histogram);
    }
...
{
    public MetricCollection(Counter<long> globalCounter, Dictionary<ulong,
        Counter<long>> guildCounter, Histogram<double> histogram)
    {
