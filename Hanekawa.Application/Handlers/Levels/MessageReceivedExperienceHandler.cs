...
public class MessageReceivedExperienceHandler: IRequestHandler<Contracts.Discord.MessageReceived>
{
    ...
    public async Task Handle(Contracts.Discord.MessageReceived request, CancellationToken cancellationToken) =>
