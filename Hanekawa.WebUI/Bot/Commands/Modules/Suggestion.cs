...
namespace Hanekawa.WebUI.Bot.Commands.Modules
{
    ...
    public class Suggestion : HanekawaCommandModule
    {
        ...
        public async Task SuggestAsync([Remainder] string suggestion)
        {
            ...
            var caseId = await db.CreateIncrementEntityAsync<global::Hanekawa.Entities.Moderation.Suggestion>(Context.GuildId, Context.Author.Id);
        ...
        private async Task RespondUser(global::Hanekawa.Entities.Moderation.Suggestion suggestion, string suggest,
            string response)
        {
            try
            {
