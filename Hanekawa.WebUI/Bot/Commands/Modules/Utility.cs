...
namespace Hanekawa.WebUI.Bot.Commands.Modules
{
    ...
    public class Utility : HanekawaCommandModule
    {
        ...
        public async Task<DiscordCommandResult> MoveAsync(IMember user)
        {
            ...
            global::Hanekawa.Entities.Account.Account movePerm = null;
            foreach (var xPair in voiceStates)
            {
                var userData = await db.GetOrCreateEntityAsync<global::Hanekawa.Entities.Account.Account>(Context.GuildId, xPair.Key);
