...
namespace Hanekawa.WebUI.Bot.Commands.Modules.Account
{
    [Name("Gamble")]
    ...
    public class Gamble : HanekawaCommandModule
    {
        ...
        public async Task<DiscordCommandResult> BetAsync(int bet)
        {
            ...
            var userData =
                await db.GetOrCreateEntityAsync<global::Hanekawa.Entities.Account.Account>(Context.GuildId, Context.Author.Id);
        ...
        private async Task<DiscordCommandResult> GambleBetAsync(DbContext db, global::Hanekawa.Entities.Account.Account userData, CurrencyConfig cfg, int bet)
        {
        ...
        private async Task<DiscordCommandResult> GambleRollAsync(DbContext db, global::Hanekawa.Entities.Account.Account userData, CurrencyConfig cfg, int bet)
        {
            bet = BetAdjust(userData, bet);
        ...
        private static int BetAdjust(global::Hanekawa.Entities.Account.Account userData, int bet)
        {
