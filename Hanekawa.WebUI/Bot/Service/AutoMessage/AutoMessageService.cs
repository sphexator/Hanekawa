...
namespace Hanekawa.WebUI.Bot.Service.AutoMessage
{
    public class AutoMessageService : DiscordClientService
    {
        ...
        public async Task<bool> AddMessage(Snowflake guildId, Snowflake creator, TimeSpan interval, string name, string message, ITextChannel channel)
        {
            ...
            var autoMessage = new global::Hanekawa.Entities.AutoMessage.AutoMessage
            {
                GuildId = guildId,
                Name = name,
                Message = message,
        ...
        private Timer CreateTimer(global::Hanekawa.Entities.AutoMessage.AutoMessage config, ITextChannel textChannel)
        {
