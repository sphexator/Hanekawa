...
namespace Hanekawa.WebUI.Bot.Service.Club
{
    public class ClubService : DiscordClientService
    {
        ...
        public async Task CreateChannelAsync(IGuild guild, ClubConfig cfg, global::Hanekawa.Entities.Club.Club club, DbService db)
        {
        ...
        public async Task AddAsync(Snowflake userId, Snowflake guildId, global::Hanekawa.Entities.Club.Club club, DbService db)
        {
        ...
        public async Task RemoveAsync(Snowflake userId, Snowflake guildId, global::Hanekawa.Entities.Club.Club club, DbService db)
        {
        ...
        public async Task RemoveAsync(ClubUser clubUser, global::Hanekawa.Entities.Club.Club club, DbService db)
        {
