...
// using Hanekawa.Infrastructure.Tables.Account.HungerGame;
...
//         }
//
//         private async Task StartSignUpAsync(HungerGameConfig cfg, DbService db)
//         {
...
//         }
//
//         private async Task<bool> StartGameAsync(HungerGameConfig cfg, DbService db, bool test = false)
//         {
...
//         }
//
//         private async Task NextRoundAsync(HungerGameConfig cfg, DbService db)
//         {
...
//         }
//
//         private async Task SendResultsAsync(HungerGameConfig cfg, Database.Tables.Account.HungerGame.Game game, List<UserAction> result, int alive,
//             CachedGuild guild)
//         {
//             var sb = new StringBuilder();
...
//         }
//
//         private async Task RewardWinnerAsync(HungerGameConfig cfg, DbService db, List<UserAction> result,
...
//         }
//
//         private async Task<IRole> RewardRoleAsync(HungerGameConfig cfg, IMember winner)
//         {
